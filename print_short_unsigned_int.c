...
/**
 * print_short_unsigned_int - implementation of 'u' conversion specifier
 * @ap: va_list
 * @mods: modfiers
 ...
 */
int print_short_unsigned_int(va_list ap,
			     char *mods,
			     char *buffer, int *len_ptr)
{
	unsigned short int n, tmp;
	int i, len, digit;
