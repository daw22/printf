...
/**
 * print_long_hexa_lower - Prints the hexa form of a number arg
 ...
 */
int print_long_hexa_lower(va_list ap, char *mods, char *buffer, int *len_ptr)
{
	...
	if (num < 0)
	{
		return (hash + print_long_neg_hexa(-1 * num,
					    hexa_digits, buffer, len_ptr));
	}
